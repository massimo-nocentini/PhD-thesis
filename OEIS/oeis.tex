...
The description of each tool is addressed in the following sections, respectively.
...
In the next examples we show how \verb|pprinting|'s facilities about
filters application, data-only visualization and search by an open query,
respectively.
