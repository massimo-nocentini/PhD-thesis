...
\begin{figure}
\includegraphics[width=15cm]{deps/oeis-tools/doc/OEIS/oeis-page}
...
\VerbatimInput[fontsize=\small]{deps/oeis-tools/doc/OEIS/crawler-help.txt}
...
\VerbatimInput[fontsize=\small]{deps/oeis-tools/doc/OEIS/crawler-fetching-command.txt}
After stopping the crawler, we check the content of cache with the commands
\VerbatimInput[fontsize=\small]{deps/oeis-tools/doc/OEIS/crawler-status.txt} which tell us that
...
\VerbatimInput[fontsize=\small]{deps/oeis-tools/doc/OEIS/crawler-restarting.txt}
...
numbers as follows
\VerbatimInput[fontsize=\small]{deps/oeis-tools/doc/OEIS/crawler-A000045-chunk.txt}
\end{example}
...
The script presents a help message to explain itself:
\VerbatimInput[fontsize=\small]{deps/oeis-tools/doc/OEIS/pprinting-help.txt} In the next examples
...
\VerbatimInput[fontsize=\small]{deps/oeis-tools/doc/OEIS/pprinting-A000045.txt}
...
\VerbatimInput[fontsize=\small]{deps/oeis-tools/doc/OEIS/pprinting-data-only.txt}
\end{example}
...
returned list only,
\VerbatimInput[fontsize=\small]{deps/oeis-tools/doc/OEIS/pprinting-pascal-matrix.txt}
\end{example}
...
\begin{figure}
\includegraphics{deps/oeis-tools/doc/OEIS/notebook-fibonacci}
...
\begin{figure}
\includegraphics{deps/oeis-tools/doc/OEIS/notebook-catalan}
...
\begin{figure}
\includegraphics{deps/oeis-tools/doc/OEIS/notebook-pascal}
...
\VerbatimInput[fontsize=\small]{deps/oeis-tools/doc/OEIS/graphing-help.txt}
