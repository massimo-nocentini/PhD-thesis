...
\publisher{ \par
            {\small Candidato: \indent\indent\indent dott. \textbf{Massimo Nocentini}}\\
...
\par\smallcaps{\url{https://github.com/massimo-nocentini/}}

\par \input{LICENSE}\index{license}
...
\input{algebraic-gf-for-languages-avoiding-Riordan-patterns/upstream.tex}
