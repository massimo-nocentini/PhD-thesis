...
The classic sequence of Fibonacci's numbers, \marginnote{\url{https://oeis.org/A000045}}
\begin{minted}[fontsize=\small]{python}
...
\end{minted}
Number of matchings in ladder graph $L_n = P_2 \times P_n$, \marginnote{\url{https://oeis.org/A030186}}
\begin{minted}[fontsize=\small]{python}
...
\end{minted}
Number of matchings in graph $P_{3} \times P_{n}$, \marginnote{\url{https://oeis.org/A033506}}
\begin{minted}[fontsize=\small]{python}
...
\end{minted}
Number of matchings in graph $P_{4} \times P_{n}$, \marginnote{\url{https://oeis.org/A033507}}
\begin{minted}[fontsize=\small]{python}
...
\end{minted}
Number of matchings in graph $P_{5} \times P_{n}$, \marginnote{\url{https://oeis.org/A033508}}
\begin{minted}[fontsize=\small]{python}
